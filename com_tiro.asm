...
VERIFICA_COLISAO_TIRO proc
    ...
    ; Aqui precisaria iterar o vídeo por 15 colunas e 9 linhas a partir do endereço de DI, e verificar se tem alguma outra cor além de preto.
...
iterar_tiros_movimentar:
    ...
    MOV BX, DX                              ; Salva a coluna para verificar se após movimentar ela vai passar da 320.
